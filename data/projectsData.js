const projectsData = [
  ...
  // },
  {
    ...
    desc: 'A full stack(MERN) goal tracker app using React, Node, Express, MongoDB.',
    technologies: ['JavaScript', 'ReactJS', 'Node JS', 'MongoDB', 'Express', 'Sass', 'HTML5'],
  ...
  },
  {
    ...
    desc:
      'A movie catalogue search web app with watchlist and like features using the themoviedb API and firebase.',
    technologies: ['JavaScript', 'ReactJS', 'Firebase', 'Firestore Database', 'HTML5', 'Sass'],
    imgSrc: '/static/images/time-machine.jpg',
  },
  {
    name: 'Pomodoro Timer',
